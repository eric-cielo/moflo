...
- [ ] `npx vitest run src/modules/spells/__tests__/bwrap-sandbox.test.ts` — args correctness
- [ ] `npx vitest run src/modules/spells/__tests__/runner-bridge.test.ts` — bridge auto-loads `moflo.yaml`
- [ ] `npx vitest run src/modules/spells/__tests__/platform-sandbox.test.ts` — config + capability detection
...
- `src/modules/spells/src/core/bwrap-sandbox.ts` — Linux sandbox wrapper
- `src/modules/spells/src/core/platform-sandbox.ts` — Detection + config resolution
