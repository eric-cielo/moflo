...
| What | Where |
|------|-------|
| Step commands | `src/modules/spells/src/commands/` |
| Connectors | `src/modules/spells/src/connectors/` |
| Type definitions | `src/modules/spells/src/types/` |
| Shipped spells | `spells/shipped/` |
| User spells | `spells/` or `.claude/spells/` |
| Step command registry | `src/modules/spells/src/core/step-command-registry.ts` |
| Connector registry | `src/modules/spells/src/core/connector-registry.ts` |
...
- `src/modules/spells/src/types/spell-connector.types.ts` — connector interface
- `src/modules/spells/src/types/step-command.types.ts` — step command interface
