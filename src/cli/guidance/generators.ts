 ...
 *
 * @module @moflo/guidance/generators
 */
...
export function generateClaudeMd(profile: ProjectProfile): string {
  ...
  if (profile.guidanceControlPlane) {
    ...
    sections.push('');
    sections.push('This project uses `@moflo/guidance` to enforce these rules programmatically.');
  ...
  if (profile.guidanceControlPlane) {
    skills.push({
      ...
      instructions: [
        ...
        '',
        'This project uses `@moflo/guidance` to enforce CLAUDE.md rules programmatically.',
        '',
