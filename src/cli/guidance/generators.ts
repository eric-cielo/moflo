 ...
 *
 * @module moflo/cli/guidance/generators
 */
...
export function generateClaudeMd(profile: ProjectProfile): string {
  ...
  if (profile.guidanceControlPlane) {
    ...
    sections.push('');
    sections.push('This project uses moflo to enforce these rules programmatically.');
  ...
  if (profile.guidanceControlPlane) {
    skills.push({
      ...
      instructions: [
        ...
        '',
        'This project uses moflo to enforce CLAUDE.md rules programmatically.',
        '',
