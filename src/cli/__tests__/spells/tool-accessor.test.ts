...
import { ConnectorAccessorImpl } from '../../spells/core/connector-accessor.js';
import { SpellConnectorRegistry } from '../../spells/registry/connector-registry.js';
import type { SpellConnector } from '../../spells/types/spell-connector.types.js';
...
describe('SpellCaster connector integration', () => {
  ...
  it('runner with connector registry populates context.tools', async () => {
    const { SpellCaster } = await import('../../spells/core/runner.js');
