...
import type { CastingContext, StepCapability } from '../../../spells/types/step-command.types.js';
import type { EffectiveSandbox, SandboxCapability, SandboxConfig } from '../../../spells/core/platform-sandbox.js';
