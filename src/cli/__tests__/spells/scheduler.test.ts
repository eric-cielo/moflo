...
import {
  ...
  nextRunFromAt,
  validateSchedule,
} from '../../spells/scheduler/cron-parser.js';
import { SpellScheduler } from '../../spells/scheduler/scheduler.js';
import type { SpellExecutor, SchedulerEvent } from '../../spells/scheduler/scheduler.js';
...
describe('validateSpellDefinition with schedule', () => {
  ...
  let validateSpellDefinition: typeof import('../../spells/schema/validator.js').validateSpellDefinition;

  beforeEach(async () => {
    const mod = await import('../../spells/schema/validator.js');
