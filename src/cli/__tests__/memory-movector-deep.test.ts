/**
 * Deep Tests for Memory and MoVector Subsystems
 *
 * Covers:
...
describe('Memory Initializer', () => {
  ...
  describe('quantizeInt8 / dequantizeInt8', () => {
    ...
    it('should dequantize back to approximately original values', async () => {
      const { quantizeInt8, dequantizeInt8 } = await import('../memory/memory-initializer.js');
  ...
  describe('quantizedCosineSim', () => {
    it('should compute similarity between identical quantized vectors', async () => {
      const { quantizeInt8, quantizedCosineSim } = await import('../memory/memory-initializer.js');
    ...
    it('should return 0 for mismatched lengths', async () => {
      const { quantizedCosineSim } = await import('../memory/memory-initializer.js');
  ...
  describe('batchCosineSim', () => {
    it('should compute batch similarities', async () => {
      const { batchCosineSim } = await import('../memory/memory-initializer.js');
  ...
  describe('softmaxAttention', () => {
    it('should normalize scores to sum to 1', async () => {
      const { softmaxAttention } = await import('../memory/memory-initializer.js');
  ...
  describe('topKIndices', () => {
    it('should return top-k indices sorted by score', async () => {
      const { topKIndices } = await import('../memory/memory-initializer.js');
  ...
  describe('flashAttentionSearch', () => {
    it('should combine batch sim, topk, and softmax', async () => {
      const { flashAttentionSearch } = await import('../memory/memory-initializer.js');
      const query = new Float32Array([1, 0, 0]);
      const vectors = [
        new Float32Array([1, 0, 0]),
        new Float32Array([0, 1, 0]),
  ...
  describe('getQuantizationStats', () => {
    it('should report compression ratio ~3.92x', async () => {
      const { getQuantizationStats } = await import('../memory/memory-initializer.js');
  ...
  describe('getInitialMetadata', () => {
    it('should include schema version 3.0.0', async () => {
      const { getInitialMetadata } = await import('../memory/memory-initializer.js');
  ...
  describe('HNSW status', () => {
    it('should report unavailable when not initialized', async () => {
      const { getHNSWStatus, clearHNSWIndex } = await import('../memory/memory-initializer.js');
      clearHNSWIndex();
...
describe('Intelligence Module', () => {
  beforeEach(async () => {
    const { clearIntelligence } = await import('../memory/intelligence.js');
    clearIntelligence();
  });
  ...
  describe('getIntelligenceStats', () => {
    it('should return valid stats after initialization', async () => {
      const { initializeIntelligence, getIntelligenceStats } = await import('../memory/intelligence.js');
  ...
  describe('clearIntelligence', () => {
    it('should reset all state', async () => {
      const { initializeIntelligence, clearIntelligence, getIntelligenceStats } = await import('../memory/intelligence.js');
      await initializeIntelligence();
      clearIntelligence();
      const stats = getIntelligenceStats();
      expect(stats.sonaEnabled).toBe(false);
  ...
  describe('benchmarkAdaptation', () => {
    it('should achieve sub-0.05ms average adaptation time', async () => {
      const { initializeIntelligence, benchmarkAdaptation } = await import('../memory/intelligence.js');
      await initializeIntelligence();
  ...
  describe('getPersistenceStatus', () => {
    it('should report persistence enabled', async () => {
      const { getPersistenceStatus } = await import('../memory/intelligence.js');
...
describe('AST Analyzer', () => {
  ...
  beforeEach(async () => {
    const { ASTAnalyzer } = await import('../movector/ast-analyzer.js');
...
`;
  ...
  describe('createASTAnalyzer factory', () => {
    it('should create analyzer with custom config', async () => {
      const { createASTAnalyzer } = await import('../movector/ast-analyzer.js');
...
describe('Diff Classifier', () => {
  ...
  beforeEach(async () => {
    const { DiffClassifier } = await import('../movector/diff-classifier.js');
...
`;
  ...
  describe('assessFileRisk', () => {
    it('should assess security files as high risk', async () => {
      const { assessFileRisk } = await import('../movector/diff-classifier.js');
  ...
  describe('assessOverallRisk', () => {
    it('should compute overall risk from file risks', async () => {
      const { assessOverallRisk } = await import('../movector/diff-classifier.js');
      const files = [
  ...
  describe('validateGitRef', () => {
    it('should reject refs with shell metacharacters', async () => {
      const mod = await import('../movector/diff-classifier.js');
...
describe('Coverage Router', () => {
  ...
  beforeEach(async () => {
    const { CoverageRouter } = await import('../movector/coverage-router.js');
...
end_of_record`;
  ...
  describe('clearCoverageCache', () => {
    it('should clear cache without error', async () => {
      const { clearCoverageCache, getCoverageCacheStats } = await import('../movector/coverage-router.js');
      clearCoverageCache();
...
describe('Graph Analyzer', () => {
  describe('detectCircularDependencies', () => {
    it('should detect simple cycles', async () => {
      const { detectCircularDependencies } = await import('../movector/graph-analyzer.js');
      const graph = {
        nodes: new Map([
  ...
  describe('fallbackMinCut', () => {
    it('should partition graph into two groups', async () => {
      const { fallbackMinCut } = await import('../movector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
  ...
  describe('fallbackLouvain', () => {
    it('should detect communities in connected graph', async () => {
      const { fallbackLouvain } = await import('../movector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
      const edges: Array<[string, string, number]> = [
        ['a', 'b', 10],
        ['c', 'd', 10],
  ...
  describe('exportToDot', () => {
    it('should generate valid DOT format', async () => {
      const { exportToDot } = await import('../movector/graph-analyzer.js');
      const result = {
        graph: {
          nodes: new Map([
  ...
  describe('clearGraphCaches / getGraphCacheStats', () => {
    it('should clear and report cache', async () => {
      const { clearGraphCaches, getGraphCacheStats } = await import('../movector/graph-analyzer.js');
      clearGraphCaches();
...
describe('Q-Learning Router', () => {
  ...
  beforeEach(async () => {
    const { QLearningRouter } = await import('../movector/q-learning-router.js');
  ...
  describe('export / import', () => {
    it('should export and import Q-table', async () => {
      ...
      const mod = await import('../movector/q-learning-router.js');
  ...
  describe('createQLearningRouter factory', () => {
    it('should create router with defaults', async () => {
      const { createQLearningRouter } = await import('../movector/q-learning-router.js');
...
describe('Registry API', () => {
  it('should export rateItem function', async () => {
    const api = await import('../services/registry-api.js');
  ...
  it('should reject invalid ratings', async () => {
    const api = await import('../services/registry-api.js');
    await expect(api.rateItem('@moflo/test', 0)).rejects.toThrow('Rating must be integer 1-5');
    await expect(api.rateItem('@moflo/test', 6)).rejects.toThrow('Rating must be integer 1-5');
  });

  it('should reject non-integer ratings', async () => {
    const api = await import('../services/registry-api.js');
    await expect(api.rateItem('@moflo/test', 3.5)).rejects.toThrow('Rating must be integer 1-5');
  });
  ...
  it('should accept valid item IDs with scopes', async () => {
    ...
    try {
      await api.getRating('@moflo/test-plugin', 'plugin');
    } catch (e: any) {
...
describe('MoVector Index', () => {
  it('should export all major components', async () => {
    const movector = await import('../movector/index.js');
    expect(movector.ASTAnalyzer).toBeDefined();
    expect(movector.DiffClassifier).toBeDefined();
    expect(movector.CoverageRouter).toBeDefined();
    expect(movector.QLearningRouter).toBeDefined();
    expect(movector.createASTAnalyzer).toBeDefined();
    expect(movector.createDiffClassifier).toBeDefined();
    expect(movector.createCoverageRouter).toBeDefined();
    expect(movector.createQLearningRouter).toBeDefined();
  });

  it('should export factory functions', async () => {
    const movector = await import('../movector/index.js');
    expect(typeof movector.createASTAnalyzer).toBe('function');
    expect(typeof movector.createDiffClassifier).toBe('function');
    expect(typeof movector.createCoverageRouter).toBe('function');
    expect(typeof movector.createQLearningRouter).toBe('function');
  });

  it('should export isMovectorAvailable', async () => {
    const movector = await import('../movector/index.js');
    expect(typeof movector.isMovectorAvailable).toBe('function');
    const available = await movector.isMovectorAvailable();
    expect(typeof available).toBe('boolean');
  });

  it('should export graph analyzer utilities', async () => {
    const movector = await import('../movector/index.js');
    expect(typeof movector.detectCircularDependencies).toBe('function');
    expect(typeof movector.fallbackMinCut).toBe('function');
    expect(typeof movector.fallbackLouvain).toBe('function');
    expect(typeof movector.exportToDot).toBe('function');
  });

  it('should export diff analysis tools', async () => {
    const movector = await import('../movector/index.js');
    expect(typeof movector.assessFileRisk).toBe('function');
    expect(typeof movector.assessOverallRisk).toBe('function');
    expect(typeof movector.classifyDiff).toBe('function');
  });

  it('should export cache control functions', async () => {
    const movector = await import('../movector/index.js');
    expect(typeof movector.clearDiffCache).toBe('function');
    expect(typeof movector.clearAllDiffCaches).toBe('function');
    expect(typeof movector.clearCoverageCache).toBe('function');
    expect(typeof movector.clearGraphCaches).toBe('function');
  });
});
