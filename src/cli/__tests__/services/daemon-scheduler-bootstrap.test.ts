...
vi.mock('../../services/engine-loader.js', () => ({
  loadSpellEngine: vi.fn(),
}));

vi.mock('../../services/grimoire-builder.js', () => ({
  buildGrimoire: vi.fn(),
}));

vi.mock('../../services/daemon-spell-executor.js', () => ({
...
import type { WorkerDaemon } from '../../services/worker-daemon.js';
