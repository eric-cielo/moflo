...
describe('Command Registry (commands/index.ts)', () => {
  it('should export all core commands synchronously', async () => {
    const indexModule = await import('../commands/index.js');
...
import { OutputFormatter, Progress, Spinner, output } from '../output.js';
...
import { generateSettings, generateSettingsJson } from '../init/settings-generator.js';
import { generateClaudeMd, generateMinimalClaudeMd, CLAUDE_MD_TEMPLATES } from '../init/claudemd-generator.js';
import { DEFAULT_INIT_OPTIONS, MINIMAL_INIT_OPTIONS, FULL_INIT_OPTIONS, detectPlatform } from '../init/types.js';
import type { InitOptions, ClaudeMdTemplate } from '../init/types.js';
