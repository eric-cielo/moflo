...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['example-org/neural-demo'],
      trending: [],
      newest: [],
      official: ['example-org/neural-demo'],
      compatibilityMatrix: [
        { pluginId: 'example-org/neural-demo', pluginVersion: '3.0.0', claudeFlowVersions: ['3.x'], tested: true },
      ],
    };
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      {
        id: 'example-org/neural-demo',
        name: 'example-org/neural-demo',
        ...
        dependencies: [{ name: 'example-org/core-demo', version: '^3.0.0' }],
        type: 'core',
      ...
      },
      {
        ...
        minClaudeFlowVersion: '3.0.0',
        dependencies: [
          { name: 'example-org/core-demo', version: '^3.0.0' },
      ...
      {
        id: 'example-org/healthcare-demo',
        name: 'example-org/healthcare-demo',
      ...
      {
        id: 'example-org/financial-risk-demo',
        name: 'example-org/financial-risk-demo',
      ...
      {
        id: 'example-org/legal-contracts-demo',
        name: 'example-org/legal-contracts-demo',
      ...
      {
        id: 'example-org/code-intelligence-demo',
        name: 'example-org/code-intelligence-demo',
      ...
      {
        id: 'example-org/test-intelligence-demo',
        name: 'example-org/test-intelligence-demo',
      ...
      {
        id: 'example-org/perf-optimizer-demo',
        name: 'example-org/perf-optimizer-demo',
      ...
      {
        id: 'example-org/neural-coordination-demo',
        name: 'example-org/neural-coordination-demo',
      ...
      {
        id: 'example-org/cognitive-kernel-demo',
        name: 'example-org/cognitive-kernel-demo',
      ...
      {
        id: 'example-org/quantum-optimizer-demo',
        name: 'example-org/quantum-optimizer-demo',
      ...
      {
        id: 'example-org/hyperbolic-reasoning-demo',
        name: 'example-org/hyperbolic-reasoning-demo',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      'example-org/neural-demo',
      // Domain-specific plugins
      'example-org/healthcare-demo',
      'example-org/financial-risk-demo',
      'example-org/legal-contracts-demo',
      // Development intelligence plugins
      'example-org/code-intelligence-demo',
      'example-org/test-intelligence-demo',
      'example-org/perf-optimizer-demo',
      // Advanced AI/reasoning plugins
      'example-org/neural-coordination-demo',
      'example-org/cognitive-kernel-demo',
      'example-org/quantum-optimizer-demo',
      'example-org/hyperbolic-reasoning-demo',
    ];
