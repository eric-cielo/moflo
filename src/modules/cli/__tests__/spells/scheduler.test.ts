...
import {
  ...
  nextRunFromAt,
  validateSchedule,
} from '../../src/spells/scheduler/cron-parser.js';
import { SpellScheduler } from '../../src/spells/scheduler/scheduler.js';
import type { SpellExecutor, SchedulerEvent } from '../../src/spells/scheduler/scheduler.js';
import type { MemoryAccessor } from '../../src/spells/types/step-command.types.js';
import type { SpellResult } from '../../src/spells/types/runner.types.js';
...
describe('validateSpellDefinition with schedule', () => {
  ...
  let validateSpellDefinition: typeof import('../../src/spells/schema/validator.js').validateSpellDefinition;

  beforeEach(async () => {
    const mod = await import('../../src/spells/schema/validator.js');
