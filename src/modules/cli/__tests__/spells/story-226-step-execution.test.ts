...
import { createCompositeCommand } from '../../src/spells/commands/composite-command.js';
...
import type { YamlStepDefinition } from '../../src/spells/loaders/yaml-step-loader.js';
import type { CastingContext } from '../../src/spells/types/step-command.types.js';
...
describe('SpellConnectorRegistry Source Priority (Issue #4)', () => {
  it('should use typed ConnectorSource record (no fallback to 0)', () => {
    ...
    const registry = new SpellConnectorRegistry();
