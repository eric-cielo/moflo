...
import type { CastingContext, StepCapability } from '../../../src/spells/types/step-command.types.js';
import type { EffectiveSandbox, SandboxCapability, SandboxConfig } from '../../../src/spells/core/platform-sandbox.js';
