...
import type {
  ...
  CastingContext,
  CredentialAccessor,
} from '../../src/spells/types/step-command.types.js';
...
function createMockCommand(type: string, outputs?: OutputDescriptor[]): StepCommand {
  return {
    ...
    validate(_config: StepConfig, _context: CastingContext): ValidationResult {
      return { valid: true, errors: [] };
    },
    async execute(_config: StepConfig, _context: CastingContext): Promise<StepOutput> {
  ...
  describe('StepCommand interface', () => {
    ...
    it('should support async validation', async () => {
      const command: StepCommand = {
        ...
        async validate(_config: StepConfig, context: CastingContext) {
