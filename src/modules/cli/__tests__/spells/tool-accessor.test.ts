...
import { ConnectorAccessorImpl } from '../../src/spells/core/connector-accessor.js';
import { SpellConnectorRegistry } from '../../src/spells/registry/connector-registry.js';
import type { SpellConnector } from '../../src/spells/types/spell-connector.types.js';
...
describe('SpellCaster connector integration', () => {
  ...
  it('runner works without connector registry (backward compat)', { timeout: 30000 }, async () => {
    const { createRunner } = await import('../../src/spells/factory/runner-factory.js');
  ...
  it('runner with connector registry populates context.tools', async () => {
    const { SpellCaster } = await import('../../src/spells/core/runner.js');
    const { StepCommandRegistry } = await import('../../src/spells/core/step-command-registry.js');
