...
import { createRunner, type RunnerFactoryOptions } from '../../src/spells/factory/runner-factory.js';
...
describe('shipped connectors integration', () => {
  ...
  it('shipped connectors are registered in a fresh SpellConnectorRegistry', () => {
