 ...
 *
 * Unit tests for credential masking utilities extracted from SpellCaster (Issue #182).
 */
...
import {
  ...
  MIN_REDACT_LENGTH,
} from '../../src/spells/core/credential-masker.js';
import type { StepOutput, StepCommand } from '../../src/spells/types/step-command.types.js';
