...
`;
  ...
  describe('createASTAnalyzer factory', () => {
    it('should create analyzer with custom config', async () => {
      const { createASTAnalyzer } = await import('../src/movector/ast-analyzer.js');
...
describe('Diff Classifier', () => {
  ...
  beforeEach(async () => {
    const { DiffClassifier } = await import('../src/movector/diff-classifier.js');
...
`;
  ...
  describe('assessFileRisk', () => {
    it('should assess security files as high risk', async () => {
      const { assessFileRisk } = await import('../src/movector/diff-classifier.js');
  ...
  describe('assessOverallRisk', () => {
    it('should compute overall risk from file risks', async () => {
      const { assessOverallRisk } = await import('../src/movector/diff-classifier.js');
      const files = [
  ...
  describe('validateGitRef', () => {
    it('should reject refs with shell metacharacters', async () => {
      const mod = await import('../src/movector/diff-classifier.js');
...
describe('Coverage Router', () => {
  ...
  beforeEach(async () => {
    const { CoverageRouter } = await import('../src/movector/coverage-router.js');
...
end_of_record`;
  ...
  describe('clearCoverageCache', () => {
    it('should clear cache without error', async () => {
      const { clearCoverageCache, getCoverageCacheStats } = await import('../src/movector/coverage-router.js');
      clearCoverageCache();
...
describe('Graph Analyzer', () => {
  ...
  describe('fallbackMinCut', () => {
    it('should partition graph into two groups', async () => {
      const { fallbackMinCut } = await import('../src/movector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
  ...
  describe('fallbackLouvain', () => {
    it('should detect communities in connected graph', async () => {
      const { fallbackLouvain } = await import('../src/movector/graph-analyzer.js');
      const nodes = ['a', 'b', 'c', 'd'];
      const edges: Array<[string, string, number]> = [
        ['a', 'b', 10],
        ['c', 'd', 10],
  ...
  describe('exportToDot', () => {
    it('should generate valid DOT format', async () => {
      const { exportToDot } = await import('../src/movector/graph-analyzer.js');
      const result = {
        graph: {
          nodes: new Map([
  ...
  describe('clearGraphCaches / getGraphCacheStats', () => {
    it('should clear and report cache', async () => {
      const { clearGraphCaches, getGraphCacheStats } = await import('../src/movector/graph-analyzer.js');
      clearGraphCaches();
...
describe('Q-Learning Router', () => {
  ...
  beforeEach(async () => {
    const { QLearningRouter } = await import('../src/movector/q-learning-router.js');
  ...
  describe('export / import', () => {
    it('should export and import Q-table', async () => {
      ...
      const mod = await import('../src/movector/q-learning-router.js');
  ...
  describe('createQLearningRouter factory', () => {
    it('should create router with defaults', async () => {
      const { createQLearningRouter } = await import('../src/movector/q-learning-router.js');
