/**
 * MoVector Integration Tests
 *
 * Tests for the main movector module exports and integration.
 */
...
import {
  ...
  fallbackMinCut,
  fallbackLouvain,
} from '../../src/movector/index.js';

// Pure TS implementation — no external packages needed

describe('MoVector Module Exports', () => {
  afterEach(() => {
    vi.clearAllMocks();
  });

  describe('isMovectorAvailable', () => {
    it('should return boolean', async () => {
      const result = await isMovectorAvailable();
      expect(typeof result).toBe('boolean');
    });

    it('should always return true (pure TS implementation)', async () => {
      const result = await isMovectorAvailable();
      expect(result).toBe(true);
    });
  });

  describe('getMovectorVersion', () => {
    it('should return version string or null', async () => {
      const version = await getMovectorVersion();
  ...
  describe('Graph Analyzer Functions', () => {
    ...
    it('should export loadMovector', () => {
      expect(typeof loadMovector).toBe('function');
    });
