/**
 * Comprehensive tests for @moflo/embeddings
 */
...
import { MockEmbeddingService } from '../../src/embeddings/__tests__/mocks/mock-embedding-service.js';

import {
  chunkText,
  estimateTokens,
  reconstructFromChunks,
} from '../../src/embeddings/chunking.js';
...
import {
  ...
  l2Norm,
  isNormalized,
} from '../../src/embeddings/normalization.js';
