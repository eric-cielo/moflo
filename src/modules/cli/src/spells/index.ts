 ...
 * Spell Engine
 *
 * Generalized Spell Engine for MoFlo V4. Provides a pluggable, YAML/JSON-defined
 * spell system where every step type implements a StepCommand interface —
 * testable, reusable, and extensible.
 *
