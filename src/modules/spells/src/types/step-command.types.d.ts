...
export interface MemoryAccessor {
    ...
    search(namespace: string, query: string): Promise<Array<{
        key: string;
        value: unknown;
        score: number;
    }>>;
...
export declare const MOFLO_LEVEL_ORDER: readonly MofloLevel[];
...
export type CapabilityType = 'fs:read' | 'fs:write' | 'net' | 'shell' | 'memory' | 'credentials' | 'browser' | 'browser:evaluate' | 'agent';
/**
...
//# sourceMappingURL=step-command.types.d.ts.map