...
export type ConnectorView = Pick<SpellConnector, 'name' | 'description' | 'version' | 'capabilities' | 'listActions'>;
/**
 * Read-only accessor passed to step commands via CastingContext.
 ...
 */
export interface SpellConnector {
    readonly name: string;
    readonly description: string;
...
export interface ConnectorRegistryEntry {
    readonly connector: SpellConnector;
    readonly source: ConnectorSource;
    readonly registeredAt: Date;
}
export type ConnectorSource = 'shipped' | 'user' | 'npm';
//# sourceMappingURL=workflow-connector.types.d.ts.map