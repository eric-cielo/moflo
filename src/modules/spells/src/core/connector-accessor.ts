 ...
 * Connector Accessor
 *
 * Read-only accessor that wraps SpellConnectorRegistry for injection
 * into CastingContext. Provides connector discovery and execution without
...
export class ConnectorAccessorImpl implements ConnectorAccessor {
  ...
  constructor(private readonly registry: SpellConnectorRegistry) {}
