...
} from '../../src/movector/graph-analyzer.js';
...
describe('Graph Analyzer', () => {
  ...
  describe('loadMovector', () => {
    it('should return null when native backend is not installed', async () => {
      const result = await loadMovector();
      // Returns null or native graph interface
