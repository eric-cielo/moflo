...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@moflo/security', '@moflo/claims'],
      trending: [],
      newest: [],
      official: ['@moflo/security', '@moflo/claims'],
      compatibilityMatrix: [
  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      // Domain-specific plugins
      {
        ...
        name: '@moflo/plugin-healthcare-clinical',
      ...
      {
        id: '@moflo/plugin-financial-risk',
        name: '@moflo/plugin-financial-risk',
      ...
      {
        id: '@moflo/plugin-legal-contracts',
        name: '@moflo/plugin-legal-contracts',
      ...
      {
        id: '@moflo/plugin-code-intelligence',
        name: '@moflo/plugin-code-intelligence',
      ...
      {
        id: '@moflo/plugin-test-intelligence',
        name: '@moflo/plugin-test-intelligence',
      ...
      {
        id: '@moflo/plugin-perf-optimizer',
        name: '@moflo/plugin-perf-optimizer',
      ...
      {
        id: '@moflo/plugin-neural-coordination',
        name: '@moflo/plugin-neural-coordination',
      ...
      {
        id: '@moflo/plugin-cognitive-kernel',
        name: '@moflo/plugin-cognitive-kernel',
      ...
      {
        id: '@moflo/plugin-quantum-optimizer',
        name: '@moflo/plugin-quantum-optimizer',
      ...
      {
        id: '@moflo/plugin-hyperbolic-reasoning',
        name: '@moflo/plugin-hyperbolic-reasoning',
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      '@moflo/plugin-financial-risk',
      '@moflo/plugin-legal-contracts',
      // Development intelligence plugins
      '@moflo/plugin-code-intelligence',
      '@moflo/plugin-test-intelligence',
      '@moflo/plugin-perf-optimizer',
      // Advanced AI/reasoning plugins
      '@moflo/plugin-neural-coordination',
      '@moflo/plugin-cognitive-kernel',
      '@moflo/plugin-quantum-optimizer',
      '@moflo/plugin-hyperbolic-reasoning',
    ];
