 ...
 *
 * Bridges ruvbot (npm: ruvbot@0.1.8) with the @moflo/guidance control
 ...
 *
 * @module @moflo/guidance/ruvbot-integration
 */
...
async function requireRuvBot(): Promise<Record<string, unknown>> {
  ...
  try {
    ...
    throw new Error(
      ...
      'ruvbot is an optional peer dependency of @moflo/guidance.',
    );
  }
}
...
/**
 * Bridges a ruvbot instance with the @moflo/guidance control plane.
 *
