 ...
 *
 * Unit tests for rollback logic extracted from WorkflowRunner (Issue #182).
 */

import { describe, it, expect, vi } from 'vitest';
import { rollbackSteps } from '../src/core/rollback-orchestrator.js';
import type { CompletedStep } from '../src/core/rollback-orchestrator.js';
import type { StepResult } from '../src/types/runner.types.js';
import type { StepCommand, WorkflowContext } from '../src/types/step-command.types.js';
...
function buildContextFactory(): (index: number) => WorkflowContext {
