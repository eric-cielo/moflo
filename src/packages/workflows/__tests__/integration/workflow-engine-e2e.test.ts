 ...
 *
 * Tests:
 *   1. WorkflowRegistry discover → Runner execute (real built-in commands)
...
// ============================================================================
// 1. WorkflowRegistry discover → Runner execute
// ============================================================================
...
`);
    ...
    const registry = new WorkflowRegistry({ shippedDir });
