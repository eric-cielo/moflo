 ...
 *
 * Tests for parallel step execution through the full WorkflowRunner (Issue #247).
 */
...
describe('WorkflowRunner — parallel step execution', () => {
...
describe('validateWorkflowDefinition — parallel cross-references', () => {
  ...
  it('should reject cross-references between sibling steps in a parallel block', () => {
    ...
    const result = validateWorkflowDefinition(definition, { knownStepTypes: ['parallel', 'bash'] });
...
describe('WorkflowRunner — parallel dry-run', () => {
